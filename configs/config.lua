...
--IMPORTANT STUFF--
Config.Language = 'en' --Default valoda
Config.Framework = "VRP" --Nomaini uz framework ko izmanto tu

Config.PedsResetTime = 1000 * 60 * 30 --Ped reset timer. Katras 30 min ped mainās
Config.UseBlips = true --uzliec uz true, ja gribi lai Blip prieks bankas radas
Config.UseCopJob = true --Set to true for the interact sound alarm ogg.
Config.UseLasers = true
Config.UseItems = false --Uzliec uz true ja gribi lai izmanto itemus. TEV VAJAG 3 ITEMUS: "advancedlockpick", "thermite", "oxycutter".
--IMPORTANT STUFF--
...
--CONTROLS--
    ...
    --RECEPTION--
    Config.SendReceptionToUnlockButton = 46 --Default ir 46 (E).
    Config.DisableCamerasButton = 74 --Default ir 74 (H).
    --RECEPTION--

    --GENERAL BUTTONS--
    Config.EmptyLockerButton = 46 --Default ir 46 (E).
    Config.AlarmButton = 46 --Default ir 46 (E).
    Config.DoorButton = 46 --Default ir 46 (E).
    Config.CrackSafeButton = 46 --Default ir 46 (E).
    Config.BreakLockerButton = 46 --Default ir 46 (E).
    Config.CancelLocker = 73 --Default ir 73 (X)
    Config.PlantBombButton = 46 --Default ir 46 (E).
    Config.HackPanelButton = 46 --Default ir 46 (E).
    Config.StealCashButton = 46 --Default ir 46 (E).
    Config.ResetButton = 46 --Default ir 46 (E).
    --GENERAL BUTTONS--
...
--Bank--
Config.PacificBank = {
        name = "Central Pacific Bank", --Bankas nosaukums
        blip = vector3(246.88, 219.49, 121.28),
        copsNeeded = 0, --Policisti vajadzīgi lai sāktu bankas apzagsanu

        AlarmCoords = vector3(255.85, 222.02, 106.29), --Signalizācijas kordinātes.
        AlarmState = nil,

        ResetBank = vector3(265.55, 220.34, 101.68),

        mainReceptionEmployee = nil,
        mainReceptionEmployeeCoords = vector3(254.54, 222.38, 106.29), --Kasieres kordinātes
        mainReceptionEmployeeHeading = 169.34, --Kasieres skata virziens
        mainReceptionEmployeeState = nil,

        mainSecurityGuard = nil,
        mainSecurityGuardWeapon = nil,
        mainSecurityGuardCoords = vector3(259.86, 216.68, 106.29), --Sarga kordinātes
        mainSecurityGuardHeading = 71.00, --sarga skata virziens
        mainSecurityGuardState = nil, 

        secondSecurityGuard = nil,
        secondSecurityGuardWeapon = nil,
        secondSecurityGuardCoords = vector3(238.84, 221.8, 106.29), --Otra sarga kordinātes
        secondSecurityGuardHeading = 252.29, --Otra sarga skata virziens
        ...
        doors = {
            ...
            --Otrās durvis lejā, kas atrodas bankas kreisajā pusē--
            [4] = {
                objName = `v_ilev_bk_door`,
            ...
            --Otras durvis augšā, kas atrodas bankas kreisajā pusē--
            [5] = {
                objName = `v_ilev_bk_door`,
            ...
            --Otras durvis kas ved uz augšu, kreisajā bankas pusē--
            [6] = {
                objName = `v_ilev_bk_door`,
        ...
        cooldown = {hour = 3, minute = 0, second = 0}, --Laiks līdz banka restartējas.
        camera = {1,2,3}, --cik daudz kameras. Piemērs : {1, 2, 3}
        robbed = nil --
}
--Banka--
...
--Peds--
    --https://docs.fivem.net/docs/game-references/ped-models/ lai redzētu modeļus
    --https://wiki.rage.mp/index.php?title=Weapons lai redzētu ieročuš
Config.Reception ={
        [1] =  {
